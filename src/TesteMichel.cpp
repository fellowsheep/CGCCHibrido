 ...
 */
 ...
 int main()
 {
     ...
     GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola 3D - Michel!", nullptr, nullptr);
 ...
 void setupGeometry(Mesh& mesh)
 {
     ...
     mesh.vertexCount = sizeof(vertices) / sizeof(GLfloat) / 6;
